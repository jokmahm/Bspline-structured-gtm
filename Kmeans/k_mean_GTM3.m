...
plot(years, data_B(4,28:43), 'o-', 'LineWidth', 1);
xlabel('Year');
ylabel('Fish Biomass');
title('Age 4 Fish Biomass Data');

% Add text labels for cluster assignments at each year
for i = 1:numel(years)
    text(years(i), data_B(4, 27+i), num2str(idx(i)), 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'center', 'FontSize', 10, 'FontWeight', 'bold', 'Color', 'red');
end
